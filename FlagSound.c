...
int speakerPin = 11;
unsigned char flagSound_data=0;

// This is called at 8000 Hz to load the next sample.
ISR(TIMER1_COMPA_vect) {
  OCR2A = flagSound_data;
}

void startPlaySound(unsigned char const *data, int length)
{
...
void updateSound(unsigned char _data) {
  flagSound_data = _data;
}
